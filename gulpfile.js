...
const formatHtml = done => {
  gulp
    ...
    .pipe(htmlBeatify({ indent_size: 2 }))
...
const watch = done => {
  ...
  gulp.watch(Src_Path.html, { delay: 200 }, gulp.series(formatHtml, browserReload));
...
exports.start = gulp.parallel(watch, browserInit);
exports.dev = gulp.parallel(compileSass, minJs, formatHtml, minImages);
exports.build = gulp.parallel(compileSass, minJs, formatHtml, minImages);
